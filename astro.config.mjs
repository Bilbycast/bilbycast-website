			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: 'Ports & Firewall', slug: 'edge/firewall' },
						...
						{ label: 'CMAF & CMAF-LL Output', slug: 'edge/cmaf' },
						...
						{ label: 'Prometheus Metrics', slug: 'edge/metrics' },
						...
						{ label: 'Production Tuning', slug: 'edge/production-tuning' },
						{ label: 'Transcoding', slug: 'edge/transcoding' },
						...
						{ label: 'Security Model', slug: 'edge/security' },
						{ label: 'Remote Upgrade', slug: 'edge/upgrade' },
					],
				},
				{
					...
					items: [
						...
						{ label: 'Services', slug: 'manager/services' },
						...
						{ label: 'DVR Sessions', slug: 'manager/dvr' },
						...
						{ label: 'Adding a Device Type', slug: 'manager/adding-a-device-type' },
						...
						{ label: 'DNS Failover', slug: 'manager/dns-failover' },
						{ label: 'Security', slug: 'manager/security' },
						{ label: 'SSO & OIDC', slug: 'manager/sso' },
						{ label: 'Master Key Rotation', slug: 'manager/master-key-rotation' },
				...
				},
				{
					...
					items: [
						...
						{ label: 'Viewer Portal', slug: 'relay/portal' },
				...
				},
				{
					...
					items: [
						...
						{ label: 'Building a Gateway Sidecar', slug: 'appear-x-gateway/writing-a-gateway' },
					],
				},
